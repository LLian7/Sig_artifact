...
def paper_rows() -> List[PaperRow]:
    return [
        PaperRow("YCSig-w4-k128-H>=k", "H>=k", 128, 128, 4, 32, 2, 382.0, 212.0, 177.0, 93.0),
        PaperRow("YCSig-w4-k160-H>=k", "H>=k", 160, 160, 4, 40, 2, 478.0, 268.0, 220.0, 116.0),
        PaperRow("YCSig-w4-k128-H>=2k", "H>=2k", 128, 256, 4, 42, 6, 502.0, 359.0, 145.0, 100.0),
        PaperRow("YCSig-w4-k160-H>=2k", "H>=2k", 160, 320, 4, 52, 5, 622.0, 446.0, 179.0, 121.0),
        PaperRow("YCSig-w8-k128-H>=k", "H>=k", 128, 168, 8, 16, 2, 382.0, 202.0, 195.0, 92.0),
        PaperRow("YCSig-w8-k160-H>=k", "H>=k", 160, 219, 8, 20, 2, 478.0, 256.0, 235.0, 116.0),
        PaperRow("YCSig-w8-k128-H>=2k", "H>=2k", 128, 258, 8, 17, 3, 406.0, 263.0, 148.0, 95.0),
        PaperRow("YCSig-w8-k160-H>=2k", "H>=2k", 160, 321, 8, 22, 6, 526.0, 324.0, 203.0, 125.0),
        PaperRow("YCSig-w16-k128-H>=k", "H>=k", 128, 248, 16, 8, 2, 382.0, 209.0, 182.0, 93.0),
        PaperRow("YCSig-w16-k160-H>=k", "H>=k", 160, 292, 16, 10, 2, 478.0, 254.0, 235.0, 116.0),
        PaperRow("YCSig-w16-k128-H>=2k", "H>=2k", 128, 256, 16, 9, 4, 430.0, 217.0, 214.0, 104.0),
        PaperRow("YCSig-w16-k160-H>=2k", "H>=2k", 160, 320, 16, 11, 5, 526.0, 268.0, 259.0, 127.0),
        PaperRow("YCSig-w32-k128-H>=k", "H>=k", 128, 200, 32, 5, 1, 478.0, 165.0, 317.0, 97.0),
        PaperRow("YCSig-w32-k160-H>=k", "H>=k", 160, 320, 32, 6, 2, 574.0, 242.0, 339.0, 129.0),
        PaperRow("YCSig-w32-k128-H>=2k", "H>=2k", 128, 320, 32, 5, 2, 478.0, 230.0, 255.0, 114.0),
        PaperRow("YCSig-w32-k160-H>=2k", "H>=2k", 160, 320, 32, 6, 2, 574.0, 242.0, 339.0, 129.0),
    ]
